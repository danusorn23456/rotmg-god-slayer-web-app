...
export function Banner({ onGoDown }) {
  return (
    <div className="relative h-screen w-screen bg-center bg-cover" style={{ backgroundImage: `url(${backgroundImage})` }}>
      {/* Gradient Area */}
      ...
      <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex-col space-y-4 select-none">
          ...
          <p className="text-3xl text-center text-white drop-shadow-2xl">
